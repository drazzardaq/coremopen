  ...
  <FormSection @submitted="updatePassword">
    ...
    <template #form>
      <div class="col-span-6 sm:col-span-4">
        <InputLabel for="current_password" value="Current Password" :dark="true" />
      ...
      <div class="col-span-6 sm:col-span-4">
        <InputLabel for="password" value="New Password" :dark="true" />
      ...
      <div class="col-span-6 sm:col-span-4">
        <InputLabel for="password_confirmation" value="Confirm Password" :dark="true" />
